...
- `bsMarkerRedCross` = Only standard Leaflet options plus `size`
        ...
        options: {
            ...
            svg : function(svgOptions) //Uses svg.js (https://svgjs.dev/docs/3.0/) to create optional SVG-element inside the div
                                        //svgOptions = {draw, width, height, borderColor, backgroundColor, iconColor, marker}
        },
